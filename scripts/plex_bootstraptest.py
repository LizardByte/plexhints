...
if __name__ == "__main__":  # noqa: C901
    ...
    parser.add_argument(
        "--without-movies",
        help="Do not create Movies (new agent) section",
        default=True,
        dest="with_movies",
        action="store_false",
    )  # noqa
    parser.add_argument(
        "--without-movies-imdb",
        help="Do not create Movies (imdb agent) section",
        default=True,
        dest="with_movies_imdb",
        action="store_false",
    )  # noqa
    parser.add_argument(
        "--without-movies-tmdb",
        help="Do not create Movies (tmdb agent) section",
        default=True,
        dest="with_movies_tmdb",
        action="store_false",
    )  # noqa
    parser.add_argument(
        "--without-music",
